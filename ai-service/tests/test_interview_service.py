...
@pytest.mark.asyncio
async def test_start_should_return_provider_response_when_upstream_succeeds() -> None:
...
@pytest.mark.asyncio
async def test_start_should_fallback_to_first_unasked_question_when_upstream_times_out() -> None:
    request = _build_start_request()
...
@pytest.mark.asyncio
async def test_start_should_skip_already_asked_question_in_fallback() -> None:
    request = _build_start_request()
...
@pytest.mark.asyncio
async def test_answer_should_return_provider_decision_with_new_shape() -> None:
...
@pytest.mark.asyncio
async def test_start_should_raise_only_when_upstream_and_local_fallback_both_fail(monkeypatch) -> None:
    request = _build_start_request()
    service = InterviewService(_TimeoutProvider())

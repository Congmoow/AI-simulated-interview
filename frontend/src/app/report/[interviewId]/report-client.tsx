...
import { formatReportScore } from "@/features/reports/report-score";
import type {
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-4">
            ...
            <p className="display-title !text-[clamp(2.4rem,3vw,4rem)]">
              {formatReportScore(report.overallScore)}
            </p>
          </div>
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {Object.entries(report.dimensionScores).map(([key, value]) => (
              <div className="surface-muted p-4" key={key}>
                ...
                <p className="mt-2 text-xl font-semibold">{formatReportScore(value.score)}</p>
